...
const notifications = {
  ...
  discord: {
    ...
    notifyGroupSeries: {
      ...
      Zotac_3060ti: envOrArray(process.env.DISCORD_NOTIFY_GROUP_3060TI),
      Asus_dual_3060ti: envOrArray(process.env.DISCORD_NOTIFY_GROUP_3060TI),
      Gigabyte_3060ti: envOrArray(process.env.DISCORD_NOTIFY_GROUP_3060TI),
	  Asus_rog_3060: envOrArray(process.env.DISCORD_NOTIFY_GROUP_3060),
	  Evga_ftw_3060ti: envOrArray(process.env.DISCORD_NOTIFY_GROUP_3060ti),
      Pulse_3d: envOrArray(process.env.DISCORD_NOTIFY_GROUP_SONYPS5C),
...
const store = {
  ...
  maxPrice: {
    series: {
      ...
      Zotac_3060ti: envOrNumber(process.env.MAX_PRICE_SERIES_Zotac_3060ti),
      Asus_dual_3060ti: envOrNumber(process.env.MAX_PRICE_SERIES_Asus_dual_3060ti),
	  Asus_rog_3060: envOrNumber(process.env.MAX_PRICE_SERIES_Asus_rog_3060),
      Gigabyte_3060ti: envOrNumber(process.env.MAX_PRICE_SERIES_Gigabyte_3060ti),
      Pulse_3d: envOrNumber(process.env.MAX_PRICE_SERIES_Pulse_3d),
	  Evga_ftw_3060ti: envOrNumber(process.env.MAX_PRICE_SERIES_Evga_ftw_3060ti),
